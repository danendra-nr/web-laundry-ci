...
<div class="max-w-2xl bg-white rounded-2xl border border-gray-150 shadow-sm overflow-hidden">
    <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
        <h3 class="text-base font-bold text-gray-800">Tambah Layanan Laundry</h3>
    ...
    <form action="<?= base_url('layanan/store') ?>" method="POST" class="p-6 space-y-5">
        <?= csrf_field() ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="kode_layanan" id="kode_layanan" value="<?= old('kode_layanan') ?>" placeholder="Contoh: CK (Cuci Kering)" class="w-full px-4 py-2.5 text-sm font-medium border border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all uppercase" required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="nama_layanan" id="nama_layanan" value="<?= old('nama_layanan') ?>" placeholder="Contoh: Cuci Kering Setrika" class="w-full px-4 py-2.5 text-sm font-medium border border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all" required>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" name="harga_per_kg" id="harga_per_kg" value="<?= old('harga_per_kg') ?>" placeholder="Contoh: 7000" class="w-full px-4 py-2.5 text-sm font-medium border border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all" required>
            </div>
            ...
            <div>
                ...
                <input type="number" name="estimasi_hari" id="estimasi_hari" value="<?= old('estimasi_hari') ?>" placeholder="Contoh: 2" class="w-full px-4 py-2.5 text-sm font-medium border border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all" required>
            </div>
        </div>
